import{e,Z as t,o as a,P as s,Q as l,c as d,J as i}from"./@vue_runtime-core@3.2.47-ac740756.js";import{r as n,j as o,u as r}from"./@vue_reactivity@3.2.47-31538bbf.js";import"./@vue_shared@3.2.47-177e1703.js";const u=e({...e({name:"operator"}),setup(e){const u=n(null);let p=o({table:{firstColumn:{type:"selection",fixed:!0},
// 接口返回数据
...
// 固定列表右边（left则固定在左边）
width:200,label:"操作"}},ids:[]});const m=e=>{p.ids=e},f=()=>{p.ids.length>0&&u.value.clearSelection()},b=()=>{},c=()=>{};return(e,n)=>{const o=t("el-button"),h=t("t-table"),y=t("t-layout-page-item"),g=t("t-layout-page");return a(),s(g,null,{default:l((()=>[d(y,null,{default:l((()=>[d(h,{title:"操作列",ref_key:"selectionTable",ref:u,table:r(p).table,columns:r(p).table.columns,onSelectionChange:m,isShowPagination:!1},{toolbar:l((()=>[d(o,{size:"default",type:"primary",disabled:r(p).ids.length<1,onClick:f},{default:l((()=>[i("取消选中")])),_:1},8,["disabled"]),d(o,{size:"default",type:"primary",onClick:b},{default:l((()=>[i("新增")])),_:1}),d(o,{size:"default",type:"danger",disabled:r(p).ids.length<1,onClick:c},{default:l((()=>[i("删除")])),_:1},8,["disabled"])])),_:1},8,["table","columns"])])),_:1})])),_:1})}}});export{u as default};

...
status:1,
// *状态: 0：停用，1：启用(默认为1)',
wechat:3}};return(e,a)=>{const c=l("t-select-table"),i=l("t-form"),d=l("t-layout-page-item"),m=l("t-layout-page");return t(),p(m,null,{default:o((()=>[u(d,null,{default:o((()=>[u(i,{ref_key:"TFormDemo",ref:b,modelValue:n(v).ref,"onUpdate:modelValue":a[0]||(a[0]=e=>n(v).ref=e),formOpts:n(v),widthSize:3},{wechat:o((()=>[u(c,{table:s,columns:s.columns,"max-height":400,placeholder:"使用下拉选择表格组件",defaultSelectVal:n(v).formData.wechat,keywords:{label:"name",value:"id"},onRadioChange:h},null,8,["columns","defaultSelectVal"])])),_:1},8,["modelValue","formOpts"])])),_:1})])),_:1})}}});export{s as default};

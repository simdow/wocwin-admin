import{e,c as l,J as a,Z as t,o as u,P as n,Q as o}from"./@vue_runtime-core@3.2.47-ac740756.js";import{r as p,j as i}from"./@vue_reactivity@3.2.47-31538bbf.js";import"./@vue_shared@3.2.47-177e1703.js";const r=e({__name:"extra",setup(e){const r=p(null),s=e=>{},c=i({goodsInformation:{title:"禁止收缩",name:"goodsInformation",disabled:!0,ref:null,opts:{formData:{id:`${Math.floor(10*Math.random()+1)}`,
// *唯一ID
account:null,
// *用户账号
password:null,
...
// 相关列表
listTypeInfo:{sexList:[{key:"女",value:1},{key:"男",value:0}],accountTypeList:{0:"手机用户",1:"论坛用户",2:"平台用户"},statusList:[{key:"启用",value:1},{key:"停用",value:0}]}}}});return(e,p)=>{const i=t("el-button"),m=t("t-module-form"),b=t("t-layout-page-item"),d=t("t-layout-page");return u(),n(d,{class:"t_module_form_demo"},{default:o((()=>[l(b,{isNoMargin:""},{default:o((()=>[l(m,{title:"Title右侧插槽使用",ref_key:"sourceForm",ref:r,formOpts:c,submit:s},{extra:o((()=>[l(i,{type:"primary"},{default:o((()=>[a("主要按钮")])),_:1}),l(i,{type:"success"},{default:o((()=>[a("成功按钮")])),_:1}),l(i,{type:"danger"},{default:o((()=>[a("信息按钮")])),_:1})])),_:1},8,["formOpts"])])),_:1})])),_:1})}}});export{r as default};
